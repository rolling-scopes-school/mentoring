...
# Что необходимо сделать до 15 декабря:
1. Провести code review ["RS Selectors"](https://github.com/rolling-scopes-school/tasks/blob/master/tasks/rs-css.md) или ["English for kids"](https://github.com/rolling-scopes-school/tasks/blob/master/tasks/rslang/english-for-kids.md)
...
2. Провести очередную еженедельную встречу со своими студентами. План встречи:
    ...
    - Помощь в выполнение [COVID-19 Dashboard](https://github.com/rolling-scopes-school/tasks/blob/master/tasks/covid-dashboard.md)
        - формирование команд из 2-4 чел
    - Ответы на вопросы
